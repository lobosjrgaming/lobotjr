...
namespace LobotJR.Utils
{
    public static class AutofacSetup
    {
        public static IContainer SetupUpdater(ClientData clientData, TokenData tokenData)
        {
            ...
            builder.RegisterType<DatabaseUpdate_1_2_0_1_2_6>().As<IDatabaseUpdate>().InstancePerLifetimeScope();
            builder.RegisterType<DatabaseUpdate_1_2_6_1_3_0>().As<IDatabaseUpdate>().InstancePerLifetimeScope();
