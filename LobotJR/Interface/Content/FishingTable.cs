...
namespace LobotJR.Interface.Content
{
    public class FishTable : IContentTable
    {
        ...
        {
            return database.FishData.Read().ToList();
        }
        ...
        public void SaveData(IDatabase database, IEnumerable<TableObject> data)
        {
            ...
            if (typedData != null)
            {
                DataUtils.SyncTable(database.FishData, typedData, (source, dest) =>
                {
                    ...
                    dest.RarityId = source.RarityId;
                    dest.SizeCategoryId = source.SizeCategoryId;
    ...
    public class FishRarityTable : IContentTable
    {
        ...
        public IEnumerable<TableObject> GetSource(IDatabase database)
        {
            return database.FishRarityData.Read().ToList();
        }
    ...
    public class FishSizeTable : IContentTable
    {
        ...
        public IEnumerable<TableObject> GetSource(IDatabase database)
        {
            return database.FishSizeData.Read().ToList();
        }
